...
class BaseSphereDrawable : public Drawable
{
public:
	BaseSphereDrawable( Graphics& gfx,const std::wstring& vertexShader,const std::wstring& pixelShader,int nSubdivisions = 2,float radius = 1.0f );
	void SetParentTransformation( DirectX::FXMMATRIX transform ) noexcept;
